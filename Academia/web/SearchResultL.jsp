<%-- 
    Document   : SearchResultL
    Created on : Aug 14, 2023, 8:24:57 AM
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            try {
                                                ...
                                                String query = "SELECT * FROM lecturer WHERE L_First_name LIKE ? OR L_Last_name LIKE ?";
                                        ...
                                        <tr>       
                                            ...
                                            <td><%=Ltelephone%></td>
                                            <td>
                                                <div><a href="UpdateLecturer.jsp?Lecturer_Id=<%=lecturertID%>"style="text-decoration: none;">Edit </a></div>
                                                <div><a href="DeleteStudent.jsp?Lecturer_Id=<%=lecturertID%>"style="text-decoration: none;">Delete</a></div>
                                            </td>
                                        </tr>
                                        <%
                                                }
